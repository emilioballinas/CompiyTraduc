...
##Programa 1: 
leer dos numeros enteros desde la consola, compararlos e imprimir el mayor.

### Como ingresar los numeros
Primeramente debes de ingresar un numero, luego darle enter, luego debes de ingresar el ultimo numero y al finalizar te 
dara el numero mayor
