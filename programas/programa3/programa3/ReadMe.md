...
##Programa 3:
Programa que calcule el promedio de 4 numeros ingresadas por el usuario:

### Como ingresar los numeros
Debes de ingresar el primer numero darle enter luego el segundo siguiendo con enter y asi sucesivamente
finalmente te dara el promedio de los 4 numeros.
